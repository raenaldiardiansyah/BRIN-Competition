...
a result opens evidence and gaps without losing list context. A guest Save
action routes through contextual login and returns to the exact search with
`saved=1`.
