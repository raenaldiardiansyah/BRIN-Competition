...
import { AIHubPage } from "@/features/ai/ai-hub/AIHubPage";
import { CollaborationMatchingPage } from "@/features/ai/collaboration-matching/CollaborationMatchingPage";
import { InnovationProfilePage } from "@/features/ai/innovation-profile/InnovationProfilePage";
import { InnovationWorkspacePage } from "@/features/ai/innovation-workspace/InnovationWorkspacePage";
import { ResearchGapPage } from "@/features/ai/research-gap/ResearchGapPage";
import { NoveltyCheckerPage } from "@/features/ai/novelty-checker/NoveltyCheckerPage";
  ...
  return (
    <>
      <PageHeader
        ...
        actions={<div className="button-row"><ActionLink href="/ai/innovation-profile?profile=me">Analisis profil dengan AI</ActionLink><ActionLink href="/profiles/maya">Lihat versi publik</ActionLink></div>}
      />
      <div className="content-with-rail">
        <div className="card-list">
  ...
  return (
    <>
      <PageHeader
        ...
        actions={<div className="button-row"><ActionLink href="/ai/innovation-workspace?project=aqua-loop">Buka AI Workspace</ActionLink><ActionLink href="/projects/aqua-loop">Lihat halaman publik</ActionLink></div>}
      />
  ...
  return (
    <>
      <PageHeader
        ...
        actions={<ActionLink href="/ai/collaboration-matching?project=aqua-loop">Cari kolaborator dengan AI</ActionLink>}
      />
      <div className="filter-bar">
...
function AppShell({
  ...
  return (
    ...
    >
      ...
      <FooterRevealLayout footer={<SiteFooter />}>
...
export function PrototypeApp() {
  ...
  const page = useMemo(() => {
    ...
    if (pathname === "/ai/innovation-workspace") return <InnovationWorkspacePage />;
    if (pathname === "/ai/research-gap") return <ResearchGapPage />;
    if (pathname === "/ai/novelty-checker") return <NoveltyCheckerPage />;
    if (pathname === "/ai/industry-matching") return <IndustryMatchingPage />;
    if (pathname === "/ai/funding-recommendation") return <FundingRecommendationPage />;
    if (pathname === "/ai/commercialization") return <CommercializationPage />;
